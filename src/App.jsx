        ...
        <div style={{padding:"20px 24px",background:"var(--card)"}}>
          ...
          <div style={{marginTop:20,borderTop:"1px solid var(--border)",paddingTop:16}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:14}}>
              {/* Opay */}
              <a href="https://opay.com" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://paystack.com" target="_blank" rel="noopener noreferrer"
                style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,padding:"12px 8px",borderRadius:12,
                  background:"linear-gradient(135deg,#0ba4db,#0077a8)",textDecoration:"none",cursor:"pointer",
            ...
            <div style={{textAlign:"center",fontSize:11,color:"var(--text3)",lineHeight:1.5}}>
              After payment, contact your admin with your receipt to receive your production code.<br/>
              Or ask your course coordinator to generate one for you.
            </div>
          </div>
        </div>
      </div>
